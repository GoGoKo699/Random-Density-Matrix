...
ax1.plot(l,f(2**(n/2),l),'r-',linewidth=1,label=''r'$\alpha$')
ax1.plot(l,f(alpha,l),'b-',linewidth=1,label=''r'$\alpha_{rank}$')
ax1.plot(X,Y,'b+',markersize=1,label=''r'$| \mathbb{P}_n >$')
ax1.set_xlim(-0.05,1.05)
ax1.set_xlabel(''r'$\lambda_0$')
ax1.set_ylabel('Shannon entropy')
ax1.set_title('Global')

ax2.plot(l,f(alpha,l),'b-',linewidth=1)
ax2.plot(X,Y,'b+',markersize=1)
