...
axs[0, 0].axvline(x=(1+np.sqrt(0.3))**2,color='gray',linestyle='dotted')
axs[0, 0].set_xlim(-0.2,6.2)
axs[0, 0].set_xticks([0,1,2,3,4,5,6])
...
axs[0, 1].axvline(x=(1+np.sqrt(0.6))**2,color='gray',linestyle='dotted')
axs[0, 1].set_xlim(-0.2,6.2)
...
axs[1, 0].axvline(x=(1+np.sqrt(1.0))**2,color='gray',linestyle='dotted')
axs[1, 0].set_xlim(-0.2,6.2)
...
axs[1, 1].axvline(x=(1+np.sqrt(2.0))**2,color='gray',linestyle='dotted')
axs[1, 1].set_xlim(-0.2,6.2)
axs[1, 1].set_xticks([0,1,2,3,4,5,6])
